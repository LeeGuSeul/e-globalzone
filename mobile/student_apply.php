<?php include $_SERVER['DOCUMENT_ROOT']."/global/mobile/file/head.php"; ?>
		...
		<div class="wrap">
            ...
            <div class="input_box">
                <p>e-글로벌 존 예약 방침</p>
                <textarea readonly>[ 무단 예약 부도에 대한 동의 ] 예약 신청 후, 예약 취소 또는 관리자의 확인 없이 예약 부도(일명 No Show)시, 관련 규정에 따라, 불이익이 주어짐에 동의합니다.</textarea>
            </div>
            <!-- // -->
            <div class="agree">
                <div class="all_agree">
                    <input type="checkbox" id="a1" name="전체동의" />
                    <label for="a1"><span>e - 글로벌 존 예약 방침에 동의합니다.</span></label>
                </div>
            </div>
            <!-- // -->
            <div class="btn_wrap">
