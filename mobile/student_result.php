<?php include $_SERVER['DOCUMENT_ROOT']."/global/mobile/file/head.php"; ?>
		...
		<div class="wrap mobile_result">
            <ul class="tab no3">
				<li><a href="student_reservation.php">예약 조회</a></li>
				<li><a href="student_schedule.php">스케줄 조회</a></li>
				<li><a href="student_result.php" class="on">결과 관리</a></li>
			</ul>
			<!-- // -->
            <p class="tit">2020년 1학기</p>
            <div class="point_info">
                <p><span class="name">이구슬</span> 학생의<br />글로벌 포인트 현황</p>
                <div class="result"><span class="rank">상위 10%</span>8<span class="times">회</span></div>
            </div>
			<!-- // -->
            ...
            <div class="history_wrap">
                <div class="month_move">
                    <p>2020년 7월</p>
                    <div class="arrow">
                        <a href="#"><img src="/global/mobile/img/month_move_prev.gif" alt="이전 달" /></a>
                        <a href="#"><img src="/global/mobile/img/month_move_next.gif" alt="다음 달" /></a>
                    </div>
                </div>
                <div>
                    <a href=""></a>
