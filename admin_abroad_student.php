                    ...
                    <table class="student_manage_table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" class="align">예약 미승인<br />횟수<img src="/global/img/table_align_arrow.gif" alt="예약 미승인 횟수 기준 정렬" /></th>
                                <th rowspan="2" class="align">결과 지연<br />입력 횟수<img src="/global/img/table_align_arrow.gif" alt="결과 지연 입력 횟수 기준 정렬" /></th>
                            </tr>
                            <tr>
                                <th>학번</th>
                                <th>이름</th>
                                <th rowspan="2" class="align">계열학과<img src="/global/img/table_align_arrow.gif" alt="계열학과 기준 정렬" /></th>
                                <th rowspan="2" class="align">합계<img src="/global/img/table_align_arrow.gif" alt="합계 기준 정렬" /></th>
                                <th rowspan="2" class="align">6월<img src="/global/img/table_align_arrow.gif" alt="6월 기준 정렬" /></th>
                                <th rowspan="2" class="align">7월<img src="/global/img/table_align_arrow.gif" alt="7월 기준 정렬" /></th>
                                <th rowspan="2" class="align">8월<img src="/global/img/table_align_arrow.gif" alt="8월 기준 정렬" /></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="eng">
                                ...
                                <td>영어</td>
                                <td>미국</td>
                                <td><div class="favor"><img src="/global/img/favor_on.png" alt="즐겨찾기 on" /></div></td> 
                                <!-- favor_on.png, favor_off.png -->
                                <td>1901192</td>
                                <td>알무카메토바 아니사</td>
                                <td>건축</td>
                                <td>3시간 30분</td>
